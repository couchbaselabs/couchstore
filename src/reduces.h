...
extern "C" {
    ...
    couchstore_error_t by_seq_rereduce(char *dst, size_t *size_r, nodelist *leaflist, int count);

    couchstore_error_t by_id_rereduce(char *dst, size_t *size_r, nodelist *leaflist, int count);
