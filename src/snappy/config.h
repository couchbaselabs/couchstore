/* src/snappy/snappy-1.0.4/config.h.  Generated from config.h.in by configure.  */
...
#define PACKAGE_STRING "Apache CouchDB 1.2.0a-332dd6c-git"
...
#define PACKAGE_VERSION "1.2.0a-332dd6c-git"

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Version number of package */
#define VERSION "1.2.0a-332dd6c-git"
